...
REM
REM Generated by Vivado on Mon Jun 17 11:45:15 +0530 2024
...
call xsim  test_MySWLED_behav -key {Behavioral:sim_1:Functional:test_MySWLED} -tclbatch test_MySWLED.tcl -log simulate.log
